		...
		function c.jc(d, n)
			...
			local M =
				game:GetService("TweenService"):Create(
					...
					{
				Size = UDim2.new(0, d.AbsoluteSize.X * 1.5, 0, d.AbsoluteSize.X * 1.5),
				ImageTransparency = 1
			}
				)
			M.Completed:Connect(
	...
	CreateWindow = function(self, N)
		...
		game:GetService "UserInputService".InputChanged:Connect(
			...
			if V and _.UserInputType == Enum.UserInputType.MouseMovement then
				...
				game:GetService("TweenService"):Create(U, TweenInfo.new(0.15), {
					Size = a2
				}):Play()
			end
		end
		...
		function h:CreateTab(a3)
			...
			local function aa()
				...
				b[1]().tw(
					...
					d = "Out",
					g = {
						TextColor3 = a.Theme[N.Theme or "Quizzy"]["Text Tab Select"]
					}
				}
				):Play()
				delay(
			...
			function ad:CreateDropdown(ae)
				...
				local av =
					...
					g(
								"UIStroke",
								{
						Color = a.Theme[N.Theme or "Quizzy"]["Dropdown Select Stroke"],
						Transparency = 1
					}
							),
					g(
			...
			function ad:CreateSlider(ae)
				...
				local function a_(aX)
					...
					b[1]().tw(
						...
						d = "Out",
						g = {
							Size = UDim2.new((aX - aS) / (aT - aS), 0, 1, 0)
						}
					}
					):Play()
